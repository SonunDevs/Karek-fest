...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = EXHIBZ_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( EXHIBZ_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'exhibz' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'exhibz' ),
					'hand'				 => esc_html__( 'Hand Icons', 'exhibz' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'exhibz' ),
					'gender'			 => esc_html__( 'Gender Icons', 'exhibz' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'exhibz' ),
					'payment'			 => esc_html__( 'Payment Icons', 'exhibz' ),
					'currency'			 => esc_html__( 'Currency Icons', 'exhibz' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'exhibz' ),
					'directional'		 => esc_html__( 'Directional Icons', 'exhibz' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'exhibz' ),
					'brand'				 => esc_html__( 'Brand Icons', 'exhibz' ),
					'medical'			 => esc_html__( 'Medical Icons', 'exhibz' ),
					'exhibz-icons'	 => esc_html__( 'exhibz Icons', 'exhibz' ),
				),
				'icons'				 => array(
					...
					//exhibz Icons
					'icon icon-building' => array('group' => 'exhibz-icons'),
					'icon icon-cycle' => array('group' => 'exhibz-icons'),
					'icon icon-food' => array('group' => 'exhibz-icons'),
					'icon icon-fun' => array('group' => 'exhibz-icons'),
					'icon icon-hotel' => array('group' => 'exhibz-icons'),
					'icon icon-marketing' => array('group' => 'exhibz-icons'),
					'icon icon-Monetizing' => array('group' => 'exhibz-icons'),
					'icon icon-netwrorking' => array('group' => 'exhibz-icons'),
					'icon icon-people' => array('group' => 'exhibz-icons'),
					'icon icon-planning' => array('group' => 'exhibz-icons'),
					'icon icon-pricing-1Asset-1' => array('group' => 'exhibz-icons'),
					'icon icon-pricing-2Asset-2' => array('group' => 'exhibz-icons'),
					'icon icon-pricing-3Asset-3' => array('group' => 'exhibz-icons'),
					'icon icon-ring-1Asset-1' => array('group' => 'exhibz-icons'),
					'icon icon-ring-2Asset-1' => array('group' => 'exhibz-icons'),
					'icon icon-ring-3Asset-2' => array('group' => 'exhibz-icons'),
					'icon icon-ring-4Asset-3' => array('group' => 'exhibz-icons'),
					'icon icon-speaker' => array('group' => 'exhibz-icons'),
					'icon icon-home' => array('group' => 'exhibz-icons'),
					'icon icon-apartment' => array('group' => 'exhibz-icons'),
					'icon icon-pencil' => array('group' => 'exhibz-icons'),
					'icon icon-magic-wand' => array('group' => 'exhibz-icons'),
					'icon icon-drop' => array('group' => 'exhibz-icons'),
					'icon icon-lighter' => array('group' => 'exhibz-icons'),
					'icon icon-poop' => array('group' => 'exhibz-icons'),
					'icon icon-sun' => array('group' => 'exhibz-icons'),
					'icon icon-moon' => array('group' => 'exhibz-icons'),
					'icon icon-cloud' => array('group' => 'exhibz-icons'),
					'icon icon-cloud-upload' => array('group' => 'exhibz-icons'),
					'icon icon-cloud-download' => array('group' => 'exhibz-icons'),
					'icon icon-cloud-sync' => array('group' => 'exhibz-icons'),
					'icon icon-cloud-check' => array('group' => 'exhibz-icons'),
					'icon icon-database' => array('group' => 'exhibz-icons'),
					'icon icon-lock' => array('group' => 'exhibz-icons'),
					'icon icon-cog' => array('group' => 'exhibz-icons'),
					'icon icon-trash' => array('group' => 'exhibz-icons'),
					'icon icon-dice' => array('group' => 'exhibz-icons'),
					'icon icon-heart' => array('group' => 'exhibz-icons'),
					'icon icon-star' => array('group' => 'exhibz-icons'),
					'icon icon-star-half' => array('group' => 'exhibz-icons'),
					'icon icon-star-empty' => array('group' => 'exhibz-icons'),
					'icon icon-flag' => array('group' => 'exhibz-icons'),
					'icon icon-envelope' => array('group' => 'exhibz-icons'),
					'icon icon-paperclip' => array('group' => 'exhibz-icons'),
					'icon icon-inbox' => array('group' => 'exhibz-icons'),
					'icon icon-eye' => array('group' => 'exhibz-icons'),
					'icon icon-printer' => array('group' => 'exhibz-icons'),
					'icon icon-file-empty' => array('group' => 'exhibz-icons'),
					'icon icon-file-add' => array('group' => 'exhibz-icons'),
					'icon icon-enter' => array('group' => 'exhibz-icons'),
					'icon icon-exit' => array('group' => 'exhibz-icons'),
					'icon icon-graduation-hat' => array('group' => 'exhibz-icons'),
					'icon icon-license' => array('group' => 'exhibz-icons'),
					'icon icon-music-note' => array('group' => 'exhibz-icons'),
					'icon icon-film-play' => array('group' => 'exhibz-icons'),
					'icon icon-camera-video' => array('group' => 'exhibz-icons'),
					'icon icon-camera' => array('group' => 'exhibz-icons'),
					'icon icon-picture' => array('group' => 'exhibz-icons'),
					'icon icon-book' => array('group' => 'exhibz-icons'),
					'icon icon-bookmark' => array('group' => 'exhibz-icons'),
					'icon icon-user' => array('group' => 'exhibz-icons'),
					'icon icon-users' => array('group' => 'exhibz-icons'),
					'icon icon-shirt' => array('group' => 'exhibz-icons'),
					'icon icon-store' => array('group' => 'exhibz-icons'),
					'icon icon-cart' => array('group' => 'exhibz-icons'),
					'icon icon-tag' => array('group' => 'exhibz-icons'),
					'icon icon-phone-handset' => array('group' => 'exhibz-icons'),
					'icon icon-phone' => array('group' => 'exhibz-icons'),
					'icon icon-pushpin' => array('group' => 'exhibz-icons'),
					'icon icon-map-marker' => array('group' => 'exhibz-icons'),
					'icon icon-map' => array('group' => 'exhibz-icons'),
					'icon icon-location' => array('group' => 'exhibz-icons'),
					'icon icon-calendar-full' => array('group' => 'exhibz-icons'),
					'icon icon-keyboard' => array('group' => 'exhibz-icons'),
					'icon icon-spell-check' => array('group' => 'exhibz-icons'),
					'icon icon-screen' => array('group' => 'exhibz-icons'),
					'icon icon-smartphone' => array('group' => 'exhibz-icons'),
					'icon icon-tablet' => array('group' => 'exhibz-icons'),
					'icon icon-laptop' => array('group' => 'exhibz-icons'),
					'icon icon-laptop-phone' => array('group' => 'exhibz-icons'),
					'icon icon-power-switch' => array('group' => 'exhibz-icons'),
					'icon icon-bubble' => array('group' => 'exhibz-icons'),
					'icon icon-heart-pulse' => array('group' => 'exhibz-icons'),
					'icon icon-construction' => array('group' => 'exhibz-icons'),
					'icon icon-pie-chart' => array('group' => 'exhibz-icons'),
					'icon icon-chart-bars' => array('group' => 'exhibz-icons'),
					'icon icon-gift' => array('group' => 'exhibz-icons'),
					'icon icon-diamond' => array('group' => 'exhibz-icons'),
					'icon icon-dinner' => array('group' => 'exhibz-icons'),
					'icon icon-coffee-cup' => array('group' => 'exhibz-icons'),
					'icon icon-leaf' => array('group' => 'exhibz-icons'),
					'icon icon-paw' => array('group' => 'exhibz-icons'),
					'icon icon-rocket' => array('group' => 'exhibz-icons'),
					'icon icon-briefcase' => array('group' => 'exhibz-icons'),
					'icon icon-bus' => array('group' => 'exhibz-icons'),
					'icon icon-car' => array('group' => 'exhibz-icons'),
					'icon icon-train' => array('group' => 'exhibz-icons'),
					'icon icon-bicycle' => array('group' => 'exhibz-icons'),
					'icon icon-wheelchair' => array('group' => 'exhibz-icons'),
					'icon icon-select' => array('group' => 'exhibz-icons'),
					'icon icon-earth' => array('group' => 'exhibz-icons'),
					'icon icon-smile' => array('group' => 'exhibz-icons'),
					'icon icon-sad' => array('group' => 'exhibz-icons'),
					'icon icon-neutral' => array('group' => 'exhibz-icons'),
					'icon icon-mustache' => array('group' => 'exhibz-icons'),
					'icon icon-alarm' => array('group' => 'exhibz-icons'),
					'icon icon-bullhorn' => array('group' => 'exhibz-icons'),
					'icon icon-volume-high' => array('group' => 'exhibz-icons'),
					'icon icon-volume-medium' => array('group' => 'exhibz-icons'),
					'icon icon-volume-low' => array('group' => 'exhibz-icons'),
					'icon icon-volume' => array('group' => 'exhibz-icons'),
					'icon icon-mic' => array('group' => 'exhibz-icons'),
					'icon icon-hourglass' => array('group' => 'exhibz-icons'),
					'icon icon-undo' => array('group' => 'exhibz-icons'),
					'icon icon-redo' => array('group' => 'exhibz-icons'),
					'icon icon-sync' => array('group' => 'exhibz-icons'),
					'icon icon-history' => array('group' => 'exhibz-icons'),
					'icon icon-clock' => array('group' => 'exhibz-icons'),
					'icon icon-download' => array('group' => 'exhibz-icons'),
					'icon icon-upload' => array('group' => 'exhibz-icons'),
					'icon icon-enter-down' => array('group' => 'exhibz-icons'),
					'icon icon-exit-up' => array('group' => 'exhibz-icons'),
					'icon icon-bug' => array('group' => 'exhibz-icons'),
					'icon icon-code' => array('group' => 'exhibz-icons'),
					'icon icon-link' => array('group' => 'exhibz-icons'),
					'icon icon-unlink' => array('group' => 'exhibz-icons'),
					'icon icon-thumbs-up' => array('group' => 'exhibz-icons'),
					'icon icon-thumbs-down' => array('group' => 'exhibz-icons'),
					'icon icon-magnifier' => array('group' => 'exhibz-icons'),
					'icon icon-cross' => array('group' => 'exhibz-icons'),
					'icon icon-menu' => array('group' => 'exhibz-icons'),
					'icon icon-list' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-up' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-down' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-left' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-right' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-up' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-down' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-left' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-right' => array('group' => 'exhibz-icons'),
					'icon icon-move' => array('group' => 'exhibz-icons'),
					'icon icon-warning' => array('group' => 'exhibz-icons'),
					'icon icon-question-circle' => array('group' => 'exhibz-icons'),
					'icon icon-menu-circle' => array('group' => 'exhibz-icons'),
					'icon icon-checkmark-circle' => array('group' => 'exhibz-icons'),
					'icon icon-cross-circle' => array('group' => 'exhibz-icons'),
					'icon icon-plus-circle' => array('group' => 'exhibz-icons'),
					'icon icon-circle-minus' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-up-circle' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-down-circle' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-left-circle' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-right-circle' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-up-circle' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-down-circle' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-left-circle' => array('group' => 'exhibz-icons'),
					'icon icon-chevron-right-circle' => array('group' => 'exhibz-icons'),
					'icon icon-crop' => array('group' => 'exhibz-icons'),
					'icon icon-frame-expand' => array('group' => 'exhibz-icons'),
					'icon icon-frame-contract' => array('group' => 'exhibz-icons'),
					'icon icon-layers' => array('group' => 'exhibz-icons'),
					'icon icon-funnel' => array('group' => 'exhibz-icons'),
					'icon icon-text-format' => array('group' => 'exhibz-icons'),
					'icon icon-text-size' => array('group' => 'exhibz-icons'),
					'icon icon-bold' => array('group' => 'exhibz-icons'),
					'icon icon-italic' => array('group' => 'exhibz-icons'),
					'icon icon-underline' => array('group' => 'exhibz-icons'),
					'icon icon-strikethrough' => array('group' => 'exhibz-icons'),
					'icon icon-highlight' => array('group' => 'exhibz-icons'),
					'icon icon-text-align-left' => array('group' => 'exhibz-icons'),
					'icon icon-text-align-center' => array('group' => 'exhibz-icons'),
					'icon icon-text-align-right' => array('group' => 'exhibz-icons'),
					'icon icon-text-align-justify' => array('group' => 'exhibz-icons'),
					'icon icon-line-spacing' => array('group' => 'exhibz-icons'),
					'icon icon-indent-increase' => array('group' => 'exhibz-icons'),
					'icon icon-indent-decrease' => array('group' => 'exhibz-icons'),
					'icon icon-page-break' => array('group' => 'exhibz-icons'),
					'icon icon-hand' => array('group' => 'exhibz-icons'),
					'icon icon-pointer-up' => array('group' => 'exhibz-icons'),
					'icon icon-pointer-right' => array('group' => 'exhibz-icons'),
					'icon icon-pointer-down' => array('group' => 'exhibz-icons'),
					'icon icon-pointer-left' => array('group' => 'exhibz-icons'),
					'icon icon-vplay' => array('group' => 'exhibz-icons'),
					'icon icon-newsletter' => array('group' => 'exhibz-icons'),
					'icon icon-coins-2' => array('group' => 'exhibz-icons'),
					'icon icon-commerce-2' => array('group' => 'exhibz-icons'),
					'icon icon-monitor' => array('group' => 'exhibz-icons'),
					'icon icon-facebook' => array('group' => 'exhibz-icons'),
					'icon icon-business' => array('group' => 'exhibz-icons'),
					'icon icon-graphic-2' => array('group' => 'exhibz-icons'),
					'icon icon-commerce-1' => array('group' => 'exhibz-icons'),
					'icon icon-like' => array('group' => 'exhibz-icons'),
					'icon icon-home1' => array('group' => 'exhibz-icons'),
					'icon icon-phone-call' => array('group' => 'exhibz-icons'),
					'icon icon-contact' => array('group' => 'exhibz-icons'),
					'icon icon-comments' => array('group' => 'exhibz-icons'),
					'icon icon-cloud-computing' => array('group' => 'exhibz-icons'),
					'icon icon-care' => array('group' => 'exhibz-icons'),
					'icon icon-coin' => array('group' => 'exhibz-icons'),
					'icon icon-donation' => array('group' => 'exhibz-icons'),
					'icon icon-donation_2' => array('group' => 'exhibz-icons'),
					'icon icon-heart1' => array('group' => 'exhibz-icons'),
					'icon icon-dove' => array('group' => 'exhibz-icons'),
					'icon icon-drop1' => array('group' => 'exhibz-icons'),
					'icon icon-first-aid-kit' => array('group' => 'exhibz-icons'),
					'icon icon-groceries' => array('group' => 'exhibz-icons'),
					'icon icon-heartbeat' => array('group' => 'exhibz-icons'),
					'icon icon-left-arrow' => array('group' => 'exhibz-icons'),
					'icon icon-newspaper' => array('group' => 'exhibz-icons'),
					'icon icon-open-book' => array('group' => 'exhibz-icons'),
					'icon icon-down-arrow' => array('group' => 'exhibz-icons'),
					'icon icon-planet-earth' => array('group' => 'exhibz-icons'),
					'icon icon-plus-button' => array('group' => 'exhibz-icons'),
					'icon icon-poor-water-supply' => array('group' => 'exhibz-icons'),
					'icon icon-tap-water' => array('group' => 'exhibz-icons'),
					'icon icon-support' => array('group' => 'exhibz-icons'),
					'icon icon-sweater' => array('group' => 'exhibz-icons'),
					'icon icon-doctor' => array('group' => 'exhibz-icons'),
					'icon icon-team' => array('group' => 'exhibz-icons'),
					'icon icon-group' => array('group' => 'exhibz-icons'),
					'icon icon-family' => array('group' => 'exhibz-icons'),
					'icon icon-children' => array('group' => 'exhibz-icons'),
					'icon icon-team_2' => array('group' => 'exhibz-icons'),
					'icon icon-telemarketer' => array('group' => 'exhibz-icons'),
					'icon icon-water' => array('group' => 'exhibz-icons'),
					'icon icon-twitter' => array('group' => 'exhibz-icons'),
					'icon icon-twitter1' => array('group' => 'exhibz-icons'),
					'icon icon-linkedin' => array('group' => 'exhibz-icons'),
					'icon icon-youtube' => array('group' => 'exhibz-icons'),
					'icon icon-dribbble' => array('group' => 'exhibz-icons'),
					'icon icon-pinterest' => array('group' => 'exhibz-icons'),
					'icon icon-vimeo' => array('group' => 'exhibz-icons'),
					'icon icon-soundcloud' => array('group' => 'exhibz-icons'),
					'icon icon-youtube-v' => array('group' => 'exhibz-icons'),
					'icon icon-behance' => array('group' => 'exhibz-icons'),
					'icon icon-google-plus' => array('group' => 'exhibz-icons'),
					'icon icon-instagram' => array('group' => 'exhibz-icons'),
					'icon icon-hammer' => array('group' => 'exhibz-icons'),
					'icon icon-justice-1' => array('group' => 'exhibz-icons'),
					'icon icon-double-left-chevron' => array('group' => 'exhibz-icons'),
					'icon icon-double-angle-pointing-to-right' => array('group' => 'exhibz-icons'),
					'icon icon-arrow-point-to-down' => array('group' => 'exhibz-icons'),
					'icon icon-play-button' => array('group' => 'exhibz-icons'),
					'icon icon-minus' => array('group' => 'exhibz-icons'),
					'icon icon-plus' => array('group' => 'exhibz-icons'),
					'icon icon-tick' => array('group' => 'exhibz-icons'),
					'icon icon-download-arrow' => array('group' => 'exhibz-icons'),
					'icon icon-edit' => array('group' => 'exhibz-icons'),
					'icon icon-reply' => array('group' => 'exhibz-icons'),
					'icon icon-cogwheel-outline' => array('group' => 'exhibz-icons'),
					'icon icon-symbol' => array('group' => 'exhibz-icons'),
					'icon icon-calendar' => array('group' => 'exhibz-icons'),
					'icon icon-shopping-cart' => array('group' => 'exhibz-icons'),
					'icon icon-shopping-basket' => array('group' => 'exhibz-icons'),
					'icon icon-users1' => array('group' => 'exhibz-icons'),
					'icon icon-man' => array('group' => 'exhibz-icons'),
					'icon icon-support1' => array('group' => 'exhibz-icons'),
					'icon icon-favorites' => array('group' => 'exhibz-icons'),
					'icon icon-calendar1' => array('group' => 'exhibz-icons'),
					'icon icon-paper-plane' => array('group' => 'exhibz-icons'),
					'icon icon-placeholder' => array('group' => 'exhibz-icons'),
					'icon icon-phone-call1' => array('group' => 'exhibz-icons'),
					'icon icon-contact1' => array('group' => 'exhibz-icons'),
					'icon icon-email' => array('group' => 'exhibz-icons'),
					'icon icon-internet' => array('group' => 'exhibz-icons'),
					'icon icon-quote' => array('group' => 'exhibz-icons'),
					'icon icon-line' => array('group' => 'exhibz-icons'),
					'icon icon-money-3' => array('group' => 'exhibz-icons'),
					'icon icon-commerce' => array('group' => 'exhibz-icons'),
					'icon icon-tools' => array('group' => 'exhibz-icons'),
					'icon icon-pie-chart1' => array('group' => 'exhibz-icons'),
					'icon icon-diamond1' => array('group' => 'exhibz-icons'),
					'icon icon-agenda' => array('group' => 'exhibz-icons'),
					'icon icon-like1' => array('group' => 'exhibz-icons'),
					'icon icon-justice' => array('group' => 'exhibz-icons'),
					'icon icon-technology' => array('group' => 'exhibz-icons'),
					'icon icon-coins-1' => array('group' => 'exhibz-icons'),
					'icon icon-left-arrow1' => array('group' => 'exhibz-icons'),
					'icon icon-bank' => array('group' => 'exhibz-icons'),
					'icon icon-calculator' => array('group' => 'exhibz-icons'),
					'icon icon-chart2' => array('group' => 'exhibz-icons'),
					'icon icon-map-marker1' => array('group' => 'exhibz-icons'),
					'icon icon-mutual-fund' => array('group' => 'exhibz-icons'),
					'icon icon-phone1' => array('group' => 'exhibz-icons'),
					'icon icon-pie-chart2' => array('group' => 'exhibz-icons'),
					'icon icon-play' => array('group' => 'exhibz-icons'),
					'icon icon-savings' => array('group' => 'exhibz-icons'),
					'icon icon-search' => array('group' => 'exhibz-icons'),
					'icon icon-tag1' => array('group' => 'exhibz-icons'),
					'icon icon-tags' => array('group' => 'exhibz-icons'),
					'icon icon-loan' => array('group' => 'exhibz-icons'),
					'icon icon-checked' => array('group' => 'exhibz-icons'),
					'icon icon-clock1' => array('group' => 'exhibz-icons'),
					'icon icon-comment' => array('group' => 'exhibz-icons'),
					'icon icon-comments1' => array('group' => 'exhibz-icons'),
					'icon icon-consult' => array('group' => 'exhibz-icons'),
					'icon icon-consut2' => array('group' => 'exhibz-icons'),
					'icon icon-envelope1' => array('group' => 'exhibz-icons'),
					'icon icon-folder' => array('group' => 'exhibz-icons'),
					'icon icon-invest' => array('group' => 'exhibz-icons'),
					'icon icon-right-arrow2' => array('group' => 'exhibz-icons'),
					'icon icon-quote1' => array('group' => 'exhibz-icons'),
					'icon icon-deal' => array('group' => 'exhibz-icons'),
					'icon icon-left-arrow2' => array('group' => 'exhibz-icons'),
					'icon icon-team1' => array('group' => 'exhibz-icons'),
					'icon icon-tshirt' => array('group' => 'exhibz-icons'),
					'icon icon-cancel' => array('group' => 'exhibz-icons'),
					'icon icon-drink' => array('group' => 'exhibz-icons'),
					'icon icon-home2' => array('group' => 'exhibz-icons'),
					'icon icon-music' => array('group' => 'exhibz-icons'),
					'icon icon-rich' => array('group' => 'exhibz-icons'),
					'icon icon-brush' => array('group' => 'exhibz-icons'),
					'icon icon-opposite-way' => array('group' => 'exhibz-icons'),
					'icon icon-cloud-computing1' => array('group' => 'exhibz-icons'),
					'icon icon-technology-1' => array('group' => 'exhibz-icons'),
					'icon icon-rotate' => array('group' => 'exhibz-icons'),
					'icon icon-medical' => array('group' => 'exhibz-icons'),
					'icon icon-flash-1' => array('group' => 'exhibz-icons'),
					'icon icon-flash' => array('group' => 'exhibz-icons'),
					'icon icon-down-arrow1' => array('group' => 'exhibz-icons'),
					'icon icon-hours-support' => array('group' => 'exhibz-icons'),
					'icon icon-bag' => array('group' => 'exhibz-icons'),
					'icon icon-photo-camera' => array('group' => 'exhibz-icons'),
					'icon icon-search-minus' => array('group' => 'exhibz-icons'),
					'icon icon-search1' => array('group' => 'exhibz-icons'),
					'icon icon-down-arrow2' => array('group' => 'exhibz-icons'),
					'icon icon-up-arrow' => array('group' => 'exhibz-icons'),
					'icon icon-right-arrow' => array('group' => 'exhibz-icons'),
					'icon icon-left-arrows' => array('group' => 'exhibz-icons'),
					'icon icon-school' => array('group' => 'exhibz-icons'),
					'icon icon-settings' => array('group' => 'exhibz-icons'),
					'icon icon-smartphone1' => array('group' => 'exhibz-icons'),
					'icon icon-technology-11' => array('group' => 'exhibz-icons'),
					'icon icon-tool' => array('group' => 'exhibz-icons'),
					'icon icon-business1' => array('group' => 'exhibz-icons'),
					'icon icon-van-1' => array('group' => 'exhibz-icons'),
					'icon icon-van' => array('group' => 'exhibz-icons'),
					'icon icon-vegetables' => array('group' => 'exhibz-icons'),
					'icon icon-women' => array('group' => 'exhibz-icons'),
					'icon icon-vintage' => array('group' => 'exhibz-icons'),
					'icon icon-up-arrow1' => array('group' => 'exhibz-icons'),
					'icon icon-arrows' => array('group' => 'exhibz-icons'),
					'icon icon-team2' => array('group' => 'exhibz-icons'),
					'icon icon-team-1' => array('group' => 'exhibz-icons'),
					'icon icon-medal' => array('group' => 'exhibz-icons'),
					'icon icon-uturn' => array('group' => 'exhibz-icons'),
					'icon icon-apple-1' => array('group' => 'exhibz-icons'),
					'icon icon-apple' => array('group' => 'exhibz-icons'),
					'icon icon-light-bulb' => array('group' => 'exhibz-icons'),
					'icon icon-light-bulb-1' => array('group' => 'exhibz-icons'),
					'icon icon-cogwheel' => array('group' => 'exhibz-icons'),
					'icon icon-watch' => array('group' => 'exhibz-icons'),
					'icon icon-star1' => array('group' => 'exhibz-icons'),
					'icon icon-star-1' => array('group' => 'exhibz-icons'),
					'icon icon-favorite' => array('group' => 'exhibz-icons'),
					'icon icon-medical1' => array('group' => 'exhibz-icons'),
					'icon icon-eye1' => array('group' => 'exhibz-icons'),
					'icon icon-full-screen' => array('group' => 'exhibz-icons'),
					'icon icon-shuffle-arrow' => array('group' => 'exhibz-icons'),
					'icon icon-online-shopping-cart' => array('group' => 'exhibz-icons'),
					'icon icon-shopping-cart1' => array('group' => 'exhibz-icons'),
					'icon icon-heart-shape-outline' => array('group' => 'exhibz-icons'),
				),
			),
		);
	}
